...
class Location:
    ...
    def __eq__(self, other):
        return type(other) is Location and self.name == other.name and math.isclose(self.lat, other.lat) and math.isclose(self.lon, other.lon)

    def __repr__(self):
        return "Location('%s', %g, %g)" % (self.name, self.lat, self.lon)
